 ...
 */
async function deleteEntriesByDate(supabase: SupabaseClient<Database>, userId: string, date: string): Promise<number>;
```
...
**Frontend (3 kroki):** 4. ✅ Akcja `deleteColumn()` w store 5. ✅ UI menu z 3 kropkami w `DataGridHeader` 6. ✅ Przekazanie prop do `DataGridHeader` z `DataGrid`

**Testy (1 krok):** 7. ✅ Unit testy dla serwisu
